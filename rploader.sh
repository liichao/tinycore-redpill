...
rploaderfile="https://ghproxy.com/https://raw.githubusercontent.com/liichao/tinycore-redpill/$build/rploader.sh"
rploaderrepo="https://ghproxy.com/https://github.com/liichao/tinycore-redpill/raw/$build/"

redpillextension="https://ghproxy.com/https://github.com/liichao/rp-ext/raw/main/redpill${redpillmake}/rpext-index.json"
modextention="https://ghproxy.com/https://github.com/liichao/rp-ext/raw/main/rpext-index.json"
modalias4="https://ghproxy.com/https://raw.githubusercontent.com/liichao/tinycore-redpill/$build/modules.alias.4.json.gz"
modalias3="https://ghproxy.com/https://raw.githubusercontent.com/liichao/tinycore-redpill/$build/modules.alias.3.json.gz"
dtcbin="https://ghproxy.com/https://raw.githubusercontent.com/liichao/tinycore-redpill/$build/tools/dtc"
dtsfiles="https://ghproxy.com/https://raw.githubusercontent.com/liichao/tinycore-redpill/$build"
timezone="UTC"
...
function syntaxcheck() {
    ...
    if [ $# -lt 2 ] && [ "$1" == "download" ] || [ "$1" == "build" ] || [ "$1" == "ext" ] || [ "$1" == "restoresession" ] || [ "$1" == "listmods" ] || [ "$1" == "serialgen" ] || [ "$1" == "patchdtc" ] || [ "$1" == "postupdate" ]; then
        ...
        ext)
            ...
            echo "example:"
            echo "rploader.sh ext apollolake-7.0.1-42218 add https://ghproxy.com/https://raw.githubusercontent.com/liichao/rp-ext/master/e1000/rpext-index.json"
...
function postupdatev1() {
    ...
    if [ ! -n "$(which bspatch)" ]; then
        ...
        curl --location "https://ghproxy.com/https://raw.githubusercontent.com/liichao/tinycore-redpill/$build/tools/bspatch" -O
...
function downloadextractorv2() {
    ...
    curl --silent --location https://ghproxy.com/https://github.com/liichao/tinycore-redpill/blob/main/tools/xxd?raw=true --output xxd
...
- ext <platform> <option> <URL> 
  ...
  Example: 
  rploader.sh ext apollolake-7.0.1-42218 add https://ghproxy.com/https://raw.githubusercontent.com/liichao/rp-ext/master/e1000/rpext-index.json
...
function bringoverfriend() {
    ...
    #URLS=$(curl --insecure -s https://api.github.com/repos/liichao/tcrpfriend/releases/latest | jq -r ".assets[] | select(.name | contains(\"${initrd-friend}\")) | .browser_download_url")
    URLS=$(curl --insecure -s https://api.github.com/repos/liichao/tcrpfriend/releases/latest | jq -r ".assets[].browser_download_url")
...
if [ -z "$GATEWAY_INTERFACE" ]; then
    ...
    interactive)
        if [ -f interactive.sh ]; then
            ...
            curl --location --progress-bar "https://ghproxy.com/https://github.com/liichao/tinycore-redpill/raw/$build/interactive.sh" --output interactive.sh
            . ./interactive.sh
            exit 99
        fi
        ;;
